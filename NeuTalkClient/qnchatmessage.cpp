...
//    te_font.setLetterSpacing(QFont::AbsoluteSpacing, 0);             //设置字间距为3像素 //设置字间距像素值
    ...
    m_leftPixmap = QPixmap(":/img/img/Customer.png");
    m_rightPixmap = QPixmap(":/img/img/Customer.png");

    m_loadingMovie = new QMovie(this);
    m_loadingMovie->setFileName(":/img/img/loading.gif");
